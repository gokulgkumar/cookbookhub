...
urlpatterns = [ 
    ...
    path('list_userrecipes_appetizers/',views.list_userrecipes_appetizers,name='list_userrecipes_appetizers'),
    path('list_userrecipes_dessert/',views.list_userrecipes_dessert,name='list_userrecipes_dessert'),
    path('list_userrecipes_maindish/',views.list_userrecipes_maindish,name='list_userrecipes_maindish'),
    path('updaterecipe_appetizer/<int:id>',views.updaterecipe_appetizer,name='updaterecipe_appetizer'),
    path('updaterecipe_maindish/<int:id>',views.updaterecipe_maindish,name='updaterecipe_maindish'),
    path('updaterecipe_dessert/<int:id>',views.updaterecipe_dessert,name='updaterecipe_dessert'),
    path('user_update_recipe/<int:id>',views.user_update_recipe,name='user_update_recipe'),
    path('user_updaterecipe/<int:id>',views.user_updaterecipe,name='user_updaterecipe'),
    ...
    path('list_allrecipes_appetizers',views.list_allrecipes_appetizers,name='list_allrecipes_appetizers'),
    path('list_allrecipes_maindish',views.list_allrecipes_maindish,name='list_allrecipes_maindish'),
    path('list_allrecipes_dessert',views.list_allrecipes_dessert,name='list_allrecipes_dessert'),
